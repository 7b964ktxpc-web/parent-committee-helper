...
function cleanReply(text, replyMode, currentUserText = '') {
  ...
  // Критически важно: никогда не восстанавливаем цель/причину из истории.
  // Если модель выдала «рассчитана на .», возвращаем только безопасную мысль,
  // используя сумму исключительно из текущего сообщения.
